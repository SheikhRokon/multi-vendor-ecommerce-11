...
class WebsiteLogo(models.Model):
    image = models.ImageField(upload_to='LogoImage',)
...
class Coupon(models.Model):
    ...
    max_value = models.IntegerField(validators=[MaxValueValidator(
        100)], verbose_name='Coupon Quantity', null=True)  # No. of coupon
